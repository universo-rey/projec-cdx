...
- `operativa/TRACE.md`
- `operativa/README.md`
- `operativa/DATAVERSE_LIVE_ROWS_CONSUMER_SELECTED_20260618.csv`
- `workbooks/README.md`
- `workbooks/MAPA.md`
- `hitos/README.md`
- `hitos/MAPA.md`
...
- Fuente live previa: `operativa/DATAVERSE_REHIDRATACION_LIVE_READ_20260617.json` confirma `5/5` parejas source/evidence con conteo `1/1`.
- `git diff --check` -> `PASS`.
...
- `evidencia`: `operativa/DATAVERSE_LIVE_ROWS_CONSUMER_SELECTED_20260618.csv`
- `validador`: `PASS`
- `riesgo`: `BAJO`
