...
## Archivo creado
- `operativa/DATAVERSE_RUNTIME_REGISTRY_CARDINALITY_20260622.csv`

## Evidencia
- Snapshot local `operativa/DATAVERSE_POWER_PLATFORM_LIVE_INVENTORY_20260616.json` contiene 7 canonical ids `*.runtime_actions`.
