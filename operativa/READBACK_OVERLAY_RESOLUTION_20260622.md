...
| `operativa/READBACK_FULL_ACTIVATION_RECONCILIATION_20260622.md` | `SHOULD_BE_TRACKED` | Evidencia reconciliacion full activation sin regenerar paquetes. | `stage + commit` |
