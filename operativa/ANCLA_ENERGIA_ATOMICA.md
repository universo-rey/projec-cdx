...
Se abre solo desde [ANCLAS_ON_DEMAND.md](C:/Users/enzo1/PROJEC%20CDX/operativa/ANCLAS_ON_DEMAND.md) cuando el delta pide cobertura energetica.

## Orden

1. Leer `operativa/COBERTURA_ATOMICA_ENERGETICA_20260615.md`.
2. Leer `atomic/CODEX_ATOMIC_OPERATING_CONTRACT.md`.
3. Leer `operativa/NOMENCLATURA_CADENA_OPERATIVA_20260615.md`.
