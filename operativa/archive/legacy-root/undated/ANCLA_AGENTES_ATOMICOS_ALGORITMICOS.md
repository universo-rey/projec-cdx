...
Se abre solo desde [ANCLAS_ON_DEMAND.md](C:/Users/enzo1/PROJEC%20CDX/operativa/archive/legacy-root/undated/ANCLAS_ON_DEMAND.md) cuando el delta necesita delegacion.
...
1. Leer `operativa/archive/legacy-root/undated/ANCLAS_ON_DEMAND.md`.
2. Leer `operativa/archive/legacy-root/undated/COMPLEMENTOS_ON_DEMAND.md` si el agente necesita un complemento concreto.
...
- Para normalizacion de perfil Windows, usar `operativa/archive/legacy-root/undated/ENTRENAMIENTO_AGENTES_NORMALIZACION_PERFIL_WINDOWS.md` como guia corta de inspeccion, compatibilidad y stop conditions.
