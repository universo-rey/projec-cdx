...
| Dataverse | `HUBDesarrollo` | `https://org084965d9.crm.dynamics.com` | 1 | `operativa/archive/legacy-root/20260616/DATAVERSE_POWER_PLATFORM_LIVE_SUMMARY_20260616.json` |
...
| Bots/copilots | Dataverse bots + PAC copilot list | `HUBDesarrollo` | 36 | `inventarios/DATAVERSE_BOTS_LIVE_20260616.csv`, `operativa/archive/legacy-root/20260616/PAC_COPILOT_LIST_HUBDESARROLLO_20260616.txt` |
...
- `operativa/archive/legacy-root/20260616/DATAVERSE_POWER_PLATFORM_LIVE_SUMMARY_20260616.json`
- `operativa/archive/legacy-root/20260616/MICROSOFT_TENANT_LIVE_SUMMARY_20260616.json` si existe; si no existe, recrear desde inventarios sanitizados.
