...
- `operativa/archive/legacy-root/undated/BLOCKERS.md`: sin bloqueo operativo activo.
...
- `operativa/archive/root-loose/20260618/README_ARRANQUE_CODEX_CLOUD.md`: frontera cloud esperada `/workspace/projec-cdx`.
