---
artifact_id: operativa/archive/legacy-root/20260618/READBACK_DATAVERSE_WORKBOOK_BINDING_20260618.md
categoria: operativa
tipo: readback
estado: en_revision
version: 2026.06.21
...
origen: GitHub
ubicacion_repo: operativa/archive/legacy-root/20260618/READBACK_DATAVERSE_WORKBOOK_BINDING_20260618.md
etiquetas:
- operativa
- readback
- metadata
...
- `operativa/TRACE.md`
- `operativa/README.md`
- `operativa/archive/legacy-root/20260618/DATAVERSE_WORKBOOK_BINDING_20260618.csv`
- `README.md`
- `workbooks/README.md`
- `workbooks/MAPA.md`
- `hitos/README.md`
...
- `evidencia`: `operativa/archive/legacy-root/20260618/DATAVERSE_WORKBOOK_BINDING_20260618.csv`
- `validador`: `PASS`
- `riesgo`: `BAJO`
