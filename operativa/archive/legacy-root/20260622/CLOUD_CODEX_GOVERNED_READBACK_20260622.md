---
artifact_id: operativa/archive/legacy-root/20260622/CLOUD_CODEX_GOVERNED_READBACK_20260622.md
categoria: operativa
tipo: readback
estado: aprobado
version: v0.6.0-rc1
...
origen: GitHub
ubicacion_repo: operativa/archive/legacy-root/20260622/CLOUD_CODEX_GOVERNED_READBACK_20260622.md
etiquetas:
  - cloud
  - codex
  - readback
  - sentinel
relacionados:
  - operativa/archive/legacy-root/20260622/ACTA_CLOUD_CODEX_GOVERNED_20260622.md
...
- `EATOMIC` se toma de `operativa/archive/legacy-root/undated/SETUP_APERTURA_CODEX_UI.md` como agente existente, no como runtime nuevo.
