---
artifact_id: operativa/archive/legacy-root/20260622/G4_REMOTE_CHECKS_STABILIZATION_v0.6.0-rc1_20260622.md
categoria: operativa
tipo: reporte
estado: en_revision
version: 2026.06.22
...
origen: Mixto
ubicacion_repo: operativa/archive/legacy-root/20260622/G4_REMOTE_CHECKS_STABILIZATION_v0.6.0-rc1_20260622.md
etiquetas:
- cabina
- release
- github
...
- operativa/archive/legacy-root/20260622/READBACK_G4_REMOTE_CHECKS_STABILIZATION_v0.6.0-rc1_20260622.md
...
- `metadata` fallo porque `index.json` y `operativa/archive/legacy-root/undated/index.json` no estaban alineados con el paquete documental G3.
