...
## Fundamento
- `operativa/archive/legacy-root/20260616/DATAVERSE_POWER_PLATFORM_LIVE_INVENTORY_20260616.json` contiene 7 canonical ids `*.runtime_actions`.
- `operativa/archive/legacy-root/20260622/DATAVERSE_RUNTIME_REGISTRY_CARDINALITY_20260622.csv` detecta el item extra `sdu.agent.cre3c_reconciliar-shell.runtime_actions` y deja estado `OPERATOR_DECISION_REQUIRED`.
