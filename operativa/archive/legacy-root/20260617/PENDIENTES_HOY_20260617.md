---
artifact_id: operativa/archive/legacy-root/20260617/PENDIENTES_HOY_20260617.md
categoria: operativa
tipo: plan
estado: en_revision
version: 2026.06.21
...
origen: GitHub
ubicacion_repo: operativa/archive/legacy-root/20260617/PENDIENTES_HOY_20260617.md
etiquetas:
- operativa
- plan
- metadata
...
- Evidencia: `operativa/archive/legacy-root/20260617/READBACK_PAQUETES_ROUTER_AGENTS_CODEX_CLOUD_20260617.md`.
...
- Evidencia: `operativa/archive/legacy-root/20260617/READBACK_MAXIMO_ESTADO_REAL_SUPERFICIES_20260617.md`, `operativa/archive/legacy-root/20260617/MAXIMO_ESTADO_REAL_SUPERFICIES_20260617.csv`, `operativa/archive/legacy-root/20260617/FAN_IN_AGENTES_MAXIMO_ESTADO_REAL_20260617.csv`.
...
1. `Dataverse_rehidratacion_desde_paquetes`.
   ...
   - Evidencia base: `dataverse/ANCLA_REHIDRATACION.md`, `dataverse/GATE.md`, `operativa/archive/legacy-root/20260617/READBACK_REHIDRATACION_DATAVERSE_DESDE_PAQUETES_20260617.md`, `operativa/archive/legacy-root/20260617/DATAVERSE_REHIDRATACION_LIVE_READ_20260617.json`.
...
2. `SGIN_documental_lists_metadata`.
   ...
   - Evidencia base: `operativa/archive/legacy-root/20260616/READBACK_SGIN_OBSERVED_READ_ONLY_20260616.md`, `inventarios/SGIN_SHAREPOINT_LISTS_LIVE_20260616.csv` y `hitos/20260617-microsoft-sgin-hitos-documental-v1`.

3. `SPGovernance_soporte_metadata`.
   - Estado: `ACTIVE_CANDIDATE`.
   - Modo: read-only preflight, metadata-only.
   - Evidencia base: `operativa/archive/legacy-root/20260616/READBACK_SPGOVERNANCE_COMPONENT_DISAMBIGUATION_20260616.md`.

4. `SDU_runtime_queue_priorities`.
   - Estado: `ACTIVE_CANDIDATE`.
   - Modo: read-only preflight, metadata-only.
   - Evidencia base: `operativa/archive/legacy-root/20260616/READBACK_DATAVERSE_POWER_PLATFORM_TENANT_ESCRIBANIA_BITSCH_20260616.md`.

5. `Home_aspx_page_binding`.
   - Estado: `WAITING_TECHNICAL_CONTEXT`.
   - No es bloqueo humano; espera UI/PnP/page API suficiente.
   - Evidencia base: `operativa/archive/legacy-root/20260616/BINDING_HOME_SESHAT_UI_READY_20260616.md` y `operativa/archive/legacy-root/20260617/READBACK_BINDING_UI_SESHAT_HOME_ATOMOS_20260617.md`.
...
6. `Codex_Cloud_UI_smoke_capture`.
   ...
   - Evidencia base: `operativa/archive/legacy-root/20260617/CODEX_CLOUD_SMOKE_TASK_20260617.md` y `operativa/archive/legacy-root/20260617/READBACK_CODEX_CLOUD_SDK_LAUNCH_20260617.md`.
