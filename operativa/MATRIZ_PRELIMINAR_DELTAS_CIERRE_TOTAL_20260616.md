...
- Archivo: `operativa/MATRIZ_PRELIMINAR_DELTAS_CIERRE_TOTAL_20260616.csv`.
...
| `README_ARRANQUE_CODEX_CLOUD.md` | 1 | 0 | Documentacion cloud en ajuste. | Absorber con runner si smoke queda consistente. |
