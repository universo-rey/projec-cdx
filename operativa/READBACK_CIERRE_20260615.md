...
- Entrada de continuidad: `operativa/START_HERE.md`.
- Prompt reutilizable: `operativa/PROMPT_NUEVO_HILO.md`.
...
- Politicas: `operativa/MANIFESTS.md`, `operativa/RETENCION.md`, `outputs/RETENCION.md`.
...
- `operativa/MANIFESTS.md` reforzado con la regla de segundo orden.
- `operativa/RETENCION.md` reforzado con los hitos nuevos al frente.
...
- Carril C: si aparece limpieza o compactacion, exigir orden explicita y `operativa/RETENCION.md`.
