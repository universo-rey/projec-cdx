...
- `operativa/READBACK_MULTIREPO_ALIGNMENT_16_20260621.md` existe en baseline, post-baseline y HEAD.
- `operativa/READBACK_LOCAL_AGENT_CHAIN_RESOLVER_20260621.md` existe desde post-baseline y HEAD.
...
| --- | --- | --- | --- | --- | --- | --- |
| Baseline multirepo 16 | `d62dd31b` | `c7083ad5` | `COVERED_BY_BASELINE` | `inventarios/MULTIREPO_ALIGNMENT_16_20260621.*`, `operativa/READBACK_MULTIREPO_ALIGNMENT_16_20260621.md` | La baseline existe y sigue en la historia viva. | Operar desde baseline, no reconstruir. |
...
| Readback local de resolvedor | no existe en baseline | `c7083ad5` | `VALID_POST_BASELINE_DELTA` | `operativa/READBACK_LOCAL_AGENT_CHAIN_RESOLVER_20260621.md` | Cierra evidencia local del resolvedor y sus validaciones. | Usar como evidencia, no duplicar ACKs. |
