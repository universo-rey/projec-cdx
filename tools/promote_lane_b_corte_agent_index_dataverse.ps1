param(
    ...
    [string]$SourcePath = "C:\Users\enzo1\Documents\GitHub\cdf-soluciones\03_OPERACION\SESHAT_RESTO_CORTE_DELEGATION\INDICE_CORTE_AGENTES_20260617.md",
    [string]$ReadbackPath = "operativa\READBACK_PUBLICACION_INDICE_CORTE_AGENTES_SHAREPOINT_20260617.md",
...
$sourceCanonicalId = "sharepoint:corte-agent-index:20260617:v1"
$evidenceCanonicalId = "evidence:sharepoint:corte-agent-index:20260617:v1"
$batchId = "20260617_lane_b_corte_agent_index_dataverse_pointer_v1"
$sourceHash = New-Hash -Path $sourceFullPath
$readbackHash = New-Hash -Path $readbackFullPath
$sharePointUrl = "https://escribaniabitsch.sharepoint.com/sites/SeshatHubRegistroN.8/Documentos%20compartidos/INDICE_CORTE_AGENTES_20260617.md"
$sharePointItemId = "017KTOXDE5ATYNJCFLPRC2HEWRFQJMJKEM"
...
if (@($beforeSource.value).Count -eq 0) {
    $sourceBody = @{
        ...
        mon_display_name      = "Indice Corte Agentes - SeshatHub Registro N8"
...
$sourcePatchBody = @{
    mon_source_path       = "PROJEC CDX/operativa/archive/legacy-root/20260617/READBACK_PUBLICACION_INDICE_CORTE_AGENTES_SHAREPOINT_20260617.md"
    mon_source_hash       = $sourceHash
    mon_source_system     = "SHAREPOINT_SESHATHUB_DOCUMENT_ATOM"
    ...
    mon_status            = "Completed"
    mon_stop_condition    = "en_espera_de_cierre_home_link; delta_governed_by_human_authority"
...
if (@($beforeEvidence.value).Count -eq 0) {
    $evidenceBody = @{
        ...
        mon_display_name      = "Evidencia Indice Corte Agentes - SharePoint publish readback"
...
$evidencePatchBody = @{
    ...
    mon_environment_scope = "HUBDesarrollo|$EnvironmentId"
    mon_status            = "Completed"
    mon_stop_condition    = "en_espera_de_cierre_home_link; postcheck_required"
    mon_seed_batch_id     = $batchId
}
...
$result = [pscustomobject]@{
    ...
    next_delta            = "delta_lane_b_home_link_or_ui_surface_binding_after_pointer"
}
