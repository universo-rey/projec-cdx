...
- Cambiar estado a `Pending`, `Retired` o eliminar solo los ids exactos registrados en `operativa/DATAVERSE_PROMOTION_INDICE_CORTE_AGENTES_20260617.json`, segun orden del owner.
