...
- Cambiar estado a `Pending`, `Retired` o eliminar solo los ids exactos registrados en `operativa/DATAVERSE_PROMOTION_BINDING_UI_SESHAT_HOME_ATOMOS_20260617.json`, segun orden del owner.
