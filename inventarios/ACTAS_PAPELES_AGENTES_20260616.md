# Actas Y Papeles De Agentes 20260616

Inventario ordenado de actas, handoffs, readbacks y papeles de trabajo producidos por agentes en `PROJEC CDX`.
...
- Los paquetes de `hitos/` ya incluyen sus propios `README.md`, `READBACK.md`, `MANIFEST.yaml`, `INDICE.csv` y, cuando aplica, `EVIDENCIA.md`.
- Este inventario concentra la lectura operativa y deja los detalles finos dentro de cada paquete.
