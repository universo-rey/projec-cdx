...
- CANVAS_URL canonica: `http://127.0.0.1:8081/noc-web/canvas.html`
- Modo: Operativo (acciones habilitadas).
- `8081` queda definido como endpoint unico operativo para Canvas.
- `8080` queda etiquetado como `STATIC VIEW ONLY`.
